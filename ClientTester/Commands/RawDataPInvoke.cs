...
namespace ClientTester.Commands
{
    ...
    public class RawDataPInvoke
    {
        ...
        public Point GetDeviceMovement(Message message)
        {
            uint dwSize = 0;
            ...
            if (raw.Header.Type == 0) //if device is mouse
                return new Point(raw.Mouse.LastX, raw.Mouse.LastY);
            return new Point(0, 0);
        }


        public RawDataPInvoke(IntPtr hwnd)
        {
